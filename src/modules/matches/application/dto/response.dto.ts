...
import { Match, MatchShortStatusEnum, MatchTypeEnum } from '../../domain';
...
export class MatchResponseDto implements Omit<Match, 'eventExists'> {
  @ApiProperty(uuidField)
  id: string;
  ...
  @ApiProperty({
    example: [],
    description: 'Events of the match',
    isArray: true,
